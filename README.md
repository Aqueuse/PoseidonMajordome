...
The final app will be a python desktop webapp based on blockly (https://developers.google.com/blockly/) Chromium Embedded Framework (https://bitbucket.org/chromiumembedded/cef/src/master/) and CherryPy (https://cherrypy.org/).
